        ...
        return (<Modal fade={true} isOpen={!this.props.auth}>
                ...
                <ModalBody>
                    <FormGroup>
                        ...
                        <Input type="text" value={this.state.username} onChange={this.updateState('username')} placeholder="prenom_nom"/>
                    </FormGroup>
                    <FormGroup>
                        <Label>Mot de passe</Label>
                        <Input invalid={this.state.error !== null} value={this.state.password} onChange={this.updateState('password')} type="password"/>
